...
// rocket.
//=============================================================================
class UT2341RedeemerProjectile extends Projectile;
...
simulated function PostBeginPlay()
{
	...
	{
		SmokeTrail = Spawn(class'NewRedeemerTrail',self,,Location - 13 * Dir, Rotation);
...
defaultproperties
{
     ...
     ExplosionEffectClass=Class'UT2341Weapons_BETA3.FX_RedeemerExplosion'
     Team=255
     Speed=670.000000
