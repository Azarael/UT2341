class ScoreBoardDeathMatchPlus extends ScoreBoard;
...
simulated event UpdateScoreBoard(Canvas Canvas)
{
	...
	for ( i=0; i<PlayerCount; i++ )
	{
		...
		Canvas.DrawTilePartialStretched( BoxMaterial, BoxWidth, PlayerBoxSizeY);
	}
	...
	// draw player names
	//canvas.fontscaley=0.9/(1200/canvas.clipy);
...
defaultproperties
{
     ...
     MatchIDText="Stats Match ID"
     OutText="OUT"
     OutFireText="   You are OUT. Hit [Fire] to spectate."
     ReadyText="READY"
     ...
     Spacer=" "
     BoxMaterial=Texture'UTRHUDTextures.ScoreBg'
}
